...
class FISTAProblem:
    ...
    def minimise(self, x0, n_iter=10, tol=1e-6, callback=None):
        ...
        optimal_x = x0 #最终输出的weight
        momentum_x = x0
        momentum = 1

        for i in range(n_iter):   #迭代多次为了计算weight
            ...
            # 上述更新了一次权重 放在new_optimal_x; 下面开始线性搜索
            # Backtracking line search
            while self._continue_backtracking(              #利用上面得到的new_o; moment_x等来更新下面
